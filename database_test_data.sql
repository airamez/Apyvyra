...
BEGIN
    ...
    FROM (VALUES
        ...
        (3, 'Mechanical Gaming Keyboard', 'RGB backlit mechanical keyboard with blue switches', 129.99, 75.00, 80, 'GamePro', 'GamePro Tech', '1.2kg', '45x15x4cm'),
        (4, 'Wireless Gaming Mouse', 'High-precision wireless mouse with 16000 DPI', 59.99, 32.00, 120, 'GamePro', 'GamePro Tech', '95g', '12x7x4cm'),
        (5, '27-inch 4K Monitor', 'Ultra HD IPS display with HDR support', 399.99, 250.00, 45, 'ViewTech', 'ViewTech Displays', '5.5kg', '61x46x21cm'),
        (6, 'Portable SSD 1TB', 'High-speed external solid state drive', 119.99, 70.00, 95, 'DataStore', 'DataStore Corp', '50g', '10x6x1cm'),
        (7, 'Webcam 1080p HD', 'Full HD webcam with auto-focus and noise reduction', 49.99, 28.00, 110, 'CamView', 'CamView Tech', '150g', '8x5x6cm'),
        (8, 'Wireless Earbuds Pro', 'True wireless earbuds with active noise cancellation', 149.99, 85.00, 200, 'AudioTech', 'AudioTech Inc', '45g', '6x5x3cm'),
        (9, 'Smart Watch Fitness Tracker', 'Advanced fitness tracker with heart rate monitor', 199.99, 120.00, 75, 'FitTech', 'FitTech Wearables', '42g', '4x4x1cm'),
        (10, 'Laptop Stand Aluminum', 'Ergonomic adjustable laptop stand', 39.99, 20.00, 130, 'DeskPro', 'DeskPro Solutions', '680g', '26x24x5cm'),
        (11, 'USB Hub 7-Port', 'Powered USB 3.0 hub with individual switches', 29.99, 15.00, 160, 'ConnectHub', 'ConnectHub Tech', '120g', '12x5x2cm'),
        (12, 'Bluetooth Speaker Portable', 'Waterproof portable speaker with 12-hour battery', 44.99, 25.00, 140, 'SoundWave', 'SoundWave Audio', '450g', '18x7x7cm'),
        (13, 'Graphics Tablet Drawing Pad', 'Digital drawing tablet with pressure sensitivity', 89.99, 50.00, 65, 'ArtPro', 'ArtPro Digital', '780g', '35x23x1cm'),
        (14, 'LED Desk Lamp Smart', 'Adjustable LED lamp with wireless charging base', 54.99, 30.00, 90, 'LightUp', 'LightUp Home', '620g', '40x15x15cm'),
        (15, 'Cable Management Kit', 'Complete cable organization solution', 19.99, 8.00, 250, 'OrganiTech', 'OrganiTech', '200g', '20x15x5cm'),
        (16, 'Phone Stand Adjustable', 'Universal smartphone holder with adjustable angle', 14.99, 6.00, 300, 'PhoneGear', 'PhoneGear Inc', '150g', '12x8x3cm'),
        (17, 'HDMI Cable 4K 2m', 'High-speed HDMI 2.1 cable for 4K/8K displays', 12.99, 5.00, 400, 'CableTech', 'CableTech', '100g', '200x3x1cm'),
        (18, 'Surge Protector 8 Outlet', 'Power strip with USB ports and surge protection', 34.99, 18.00, 180, 'PowerSafe', 'PowerSafe Electric', '450g', '30x8x4cm'),
        (19, 'Microphone USB Condenser', 'Professional USB microphone for streaming', 79.99, 45.00, 70, 'VoicePro', 'VoicePro Audio', '380g', '16x8x8cm'),
        (20, 'Router WiFi 6 Dual Band', 'High-speed wireless router with advanced security', 129.99, 75.00, 55, 'NetSpeed', 'NetSpeed Networks', '520g', '25x18x5cm')
    ...
    FROM (VALUES
        ...
        (3, 'Coffee Maker Programmable', '12-cup programmable coffee maker with timer', 79.99, 45.00, 75, 'BrewPro', 'BrewPro Appliances', '2.3kg', '30x20x35cm'),
        (4, 'Blender High Speed', '1500W professional blender with multiple speeds', 89.99, 50.00, 65, 'BlendMaster', 'BlendMaster Home', '3.2kg', '20x20x42cm'),
        (5, 'Air Fryer 5.8 Quart', 'Digital air fryer with 8 preset cooking functions', 119.99, 70.00, 85, 'CrispyChef', 'CrispyChef Kitchen', '5.4kg', '35x30x32cm'),
        (6, 'Vacuum Sealer Machine', 'Automatic vacuum sealing system for food storage', 59.99, 35.00, 90, 'FreshKeep', 'FreshKeep Home', '1.8kg', '38x15x8cm'),
        (7, 'Knife Set Professional 15-Piece', 'High-carbon stainless steel knife set with block', 149.99, 85.00, 50, 'SharpEdge', 'SharpEdge Cutlery', '4.2kg', '35x20x25cm'),
        (8, 'Cutting Board Bamboo Set', 'Set of 3 eco-friendly bamboo cutting boards', 29.99, 15.00, 150, 'EcoKitchen', 'EcoKitchen', '2.1kg', '40x30x3cm'),
        (9, 'Mixing Bowl Set Stainless', 'Nesting mixing bowls with lids - 5 piece', 34.99, 18.00, 120, 'BowlPro', 'BowlPro Kitchen', '1.5kg', '28x28x15cm'),
        (10, 'Food Storage Container Set', '24-piece airtight food storage containers', 44.99, 25.00, 110, 'FreshKeep', 'FreshKeep Home', '2.8kg', '35x25x20cm'),
        (11, 'Dish Rack Stainless Steel', 'Large capacity dish drying rack', 39.99, 22.00, 95, 'DrainPro', 'DrainPro Home', '1.6kg', '45x32x15cm'),
        (12, 'Spice Rack Organizer', 'Rotating spice rack with 20 glass jars', 49.99, 28.00, 80, 'OrganiHome', 'OrganiHome', '2.4kg', '30x30x35cm'),
        (13, 'Toaster 4-Slice', 'Extra-wide slot toaster with bagel function', 54.99, 30.00, 70, 'ToastMaster', 'ToastMaster Kitchen', '2.1kg', '35x20x20cm'),
        (14, 'Rice Cooker 10-Cup', 'Digital rice cooker with steamer basket', 69.99, 40.00, 75, 'RicePro', 'RicePro Appliances', '3.5kg', '28x28x25cm'),
        (15, 'Pressure Cooker 6 Quart', 'Multi-function electric pressure cooker', 99.99, 60.00, 65, 'QuickCook', 'QuickCook Kitchen', '5.8kg', '32x32x33cm'),
        (16, 'Kitchen Scale Digital', 'Precision digital food scale with bowl', 24.99, 12.00, 140, 'WeighRight', 'WeighRight Home', '680g', '20x18x5cm'),
        (17, 'Can Opener Electric', 'Automatic can opener with knife sharpener', 29.99, 15.00, 100, 'OpenEasy', 'OpenEasy Kitchen', '850g', '22x10x18cm'),
        (18, 'Utensil Set Silicone', '12-piece heat-resistant cooking utensils', 34.99, 18.00, 130, 'CookPro', 'CookPro Kitchen', '980g', '35x25x8cm'),
        (19, 'Dish Soap Dispenser Pump', 'Automatic touchless soap dispenser', 19.99, 10.00, 180, 'CleanHome', 'CleanHome', '420g', '12x8x18cm'),
        (20, 'Kitchen Timer Digital', 'Magnetic timer with large display', 14.99, 7.00, 200, 'TimePro', 'TimePro Home', '120g', '8x8x2cm')
    ) AS products(generate_series, name, description, price, cost_price, stock_quantity, brand, manufacturer, weight, dimensions);
    ...
    FROM (VALUES
        ...
        (3, 'Dumbbell Set Adjustable', 'Pair of adjustable dumbbells 5-25 lbs', 149.99, 85.00, 60, 'IronFit', 'IronFit Equipment', '12kg', '40x20x20cm'),
        (4, 'Jump Rope Speed', 'Professional speed jump rope with ball bearings', 12.99, 6.00, 250, 'JumpPro', 'JumpPro Sports', '180g', '280x3x3cm'),
        (5, 'Foam Roller Massage', 'High-density foam roller for muscle recovery', 19.99, 10.00, 150, 'RecoverFit', 'RecoverFit', '450g', '33x14x14cm'),
        (6, 'Water Bottle Insulated 32oz', 'Stainless steel vacuum insulated bottle', 24.99, 12.00, 220, 'HydroMax', 'HydroMax', '380g', '28x8x8cm'),
        (7, 'Camping Tent 4-Person', 'Waterproof family camping tent with rainfly', 159.99, 95.00, 45, 'OutdoorPro', 'OutdoorPro Gear', '6.5kg', '60x25x25cm'),
        (8, 'Sleeping Bag Lightweight', 'Compact sleeping bag for 3-season camping', 49.99, 28.00, 80, 'SleepWell', 'SleepWell Outdoor', '1.4kg', '38x20x20cm'),
        (9, 'Hiking Backpack 50L', 'Durable hiking backpack with rain cover', 89.99, 50.00, 65, 'TrailMaster', 'TrailMaster Gear', '1.8kg', '65x35x25cm'),
        (10, 'Trekking Poles Adjustable', 'Pair of lightweight aluminum trekking poles', 34.99, 18.00, 100, 'HikePro', 'HikePro Equipment', '520g', '65x10x10cm'),
        (11, 'Bike Helmet Adult', 'Adjustable cycling helmet with LED light', 44.99, 25.00, 90, 'SafeRide', 'SafeRide Sports', '320g', '28x22x16cm'),
        (12, 'Bike Lock Heavy Duty', 'U-lock with cable for maximum security', 39.99, 22.00, 110, 'LockTight', 'LockTight Security', '1.2kg', '30x15x5cm'),
        (13, 'Fishing Rod Combo', 'Spinning rod and reel combo for freshwater', 79.99, 45.00, 55, 'CatchMaster', 'CatchMaster Fishing', '680g', '180x8x8cm'),
        (14, 'Cooler 30 Quart', 'Insulated cooler with wheels', 69.99, 40.00, 70, 'ChillBox', 'ChillBox Outdoor', '5.2kg', '55x35x40cm'),
        (15, 'Hammock Portable Double', 'Lightweight parachute hammock with straps', 34.99, 18.00, 120, 'RelaxPro', 'RelaxPro Outdoor', '680g', '28x15x15cm'),
        (16, 'Headlamp LED Rechargeable', 'Bright LED headlamp with multiple modes', 24.99, 12.00, 140, 'BeamBright', 'BeamBright', '95g', '8x6x4cm'),
        (17, 'Camping Stove Portable', 'Compact gas camping stove with case', 29.99, 15.00, 95, 'CookCamp', 'CookCamp Gear', '420g', '18x12x10cm'),
        (18, 'First Aid Kit Outdoor', 'Comprehensive 200-piece first aid kit', 39.99, 22.00, 100, 'SafeCamp', 'SafeCamp Medical', '780g', '22x15x8cm'),
        (19, 'Sunglasses Polarized Sport', 'UV protection polarized sports sunglasses', 29.99, 15.00, 160, 'SunShield', 'SunShield Optics', '28g', '15x6x5cm'),
        (20, 'Fitness Tracker Watch', 'Waterproof activity tracker with heart rate monitor', 49.99, 28.00, 130, 'FitTrack', 'FitTrack Tech', '35g', '4x4x1cm')
    ) AS products(generate_series, name, description, price, cost_price, stock_quantity, brand, manufacturer, weight, dimensions);
    ...
    FROM (VALUES
        ...
        (3, 'Data Science Handbook', 'Complete guide to data science and analytics', 59.99, 30.00, 75, 'DataBooks', 'DataBooks Inc', '1.1kg', '26x20x4cm'),
        (4, 'Machine Learning Basics', 'Introduction to machine learning algorithms', 44.99, 22.00, 90, 'AIPress', 'AIPress Publishing', '780g', '23x17x2cm'),
        (5, 'Cloud Computing Guide', 'Master cloud platforms and architecture', 52.99, 26.00, 80, 'CloudBooks', 'CloudBooks', '890g', '24x18x3cm'),
        (6, 'Cybersecurity Essentials', 'Protect systems and data from threats', 47.99, 24.00, 95, 'SecurePress', 'SecurePress', '820g', '24x18x3cm'),
        (7, 'Business Strategy 101', 'Essential business planning and strategy', 39.99, 20.00, 110, 'BizBooks', 'BizBooks Publishing', '680g', '23x15x2cm'),
        (8, 'Digital Marketing Mastery', 'Complete guide to online marketing', 42.99, 21.00, 100, 'MarketPress', 'MarketPress', '720g', '23x16x2cm'),
        (9, 'Photography Fundamentals', 'Learn the art of digital photography', 44.99, 22.00, 85, 'PhotoBooks', 'PhotoBooks', '950g', '26x22x2cm'),
        (10, 'Graphic Design Principles', 'Master visual design and composition', 49.99, 25.00, 75, 'DesignPress', 'DesignPress', '1.2kg', '28x24x3cm'),
        (11, 'Cooking Around the World', 'International recipes and techniques', 34.99, 17.00, 120, 'CookBooks', 'CookBooks Publishing', '980g', '26x20x3cm'),
        (12, 'Fitness and Nutrition Guide', 'Complete health and wellness handbook', 29.99, 15.00, 130, 'HealthPress', 'HealthPress', '620g', '23x15x2cm'),
        (13, 'Meditation and Mindfulness', 'Practical guide to mental wellness', 24.99, 12.00, 140, 'MindBooks', 'MindBooks', '420g', '21x14x1cm'),
        (14, 'Travel Photography Tips', 'Capture amazing travel moments', 32.99, 16.00, 95, 'TravelPress', 'TravelPress', '580g', '22x16x2cm'),
        (15, 'Home Gardening Basics', 'Grow your own vegetables and herbs', 27.99, 14.00, 110, 'GardenBooks', 'GardenBooks', '720g', '24x18x2cm'),
        (16, 'DIY Home Improvement', 'Essential home repair and renovation', 36.99, 18.00, 90, 'HomePress', 'HomePress', '880g', '25x19x3cm'),
        (17, 'Personal Finance Guide', 'Master your money and investments', 31.99, 16.00, 105, 'MoneyBooks', 'MoneyBooks', '520g', '22x15x2cm'),
        (18, 'Leadership and Management', 'Develop effective leadership skills', 41.99, 21.00, 85, 'LeadPress', 'LeadPress Publishing', '680g', '23x16x2cm'),
        (19, 'Creative Writing Workshop', 'Improve your writing craft', 28.99, 14.00, 100, 'WriteBooks', 'WriteBooks', '480g', '21x14x2cm'),
        (20, 'Music Theory Fundamentals', 'Learn the basics of music composition', 33.99, 17.00, 95, 'MusicPress', 'MusicPress', '620g', '23x17x2cm')
    ) AS products(generate_series, name, description, price, cost_price, stock_quantity, brand, manufacturer, weight, dimensions);
    ...
    FROM (VALUES
        ...
        (3, 'Hoodie Pullover', 'Comfortable fleece pullover hoodie', 39.99, 20.00, 180, 'CozyWear', 'CozyWear', '480g', 'L: 73x58cm'),
        (4, 'Running Shoes Athletic', 'Lightweight running shoes with cushioning', 79.99, 40.00, 120, 'RunFast', 'RunFast Sports', '280g', 'Size 10'),
        (5, 'Leather Belt Classic', 'Genuine leather belt with metal buckle', 29.99, 12.00, 200, 'BeltCraft', 'BeltCraft', '180g', '110cm x 3.5cm'),
        (6, 'Baseball Cap Adjustable', 'Cotton baseball cap with adjustable strap', 14.99, 6.00, 250, 'CapStyle', 'CapStyle Hats', '85g', 'One Size'),
        (7, 'Backpack Canvas', 'Durable canvas backpack for daily use', 44.99, 22.00, 140, 'BagPro', 'BagPro', '680g', '45x30x15cm'),
        (8, 'Wallet Leather Bifold', 'Slim leather bifold wallet with RFID blocking', 24.99, 10.00, 180, 'WalletCraft', 'WalletCraft', '95g', '11x9x2cm'),
        (9, 'Sunglasses Classic Aviator', 'Timeless aviator style sunglasses', 34.99, 15.00, 160, 'ShadeStyle', 'ShadeStyle Optics', '32g', '14x5x5cm'),
        (10, 'Watch Analog Casual', 'Stainless steel casual watch', 59.99, 30.00, 100, 'TimeStyle', 'TimeStyle Watches', '120g', '4cm diameter'),
        (11, 'Scarf Wool Winter', 'Warm wool scarf for cold weather', 24.99, 10.00, 150, 'WarmWear', 'WarmWear', '180g', '180x30cm'),
        (12, 'Gloves Leather Touchscreen', 'Leather gloves with touchscreen fingertips', 29.99, 12.00, 130, 'GloveTech', 'GloveTech', '95g', 'Size L'),
        (13, 'Socks Athletic 6-Pack', 'Moisture-wicking athletic socks', 19.99, 8.00, 220, 'SockFit', 'SockFit', '240g', 'Size 9-11'),
        (14, 'Tie Silk Classic', 'Premium silk necktie', 24.99, 10.00, 140, 'TieStyle', 'TieStyle', '65g', '145x8cm'),
        (15, 'Dress Shirt Button-Down', 'Classic cotton dress shirt', 39.99, 18.00, 160, 'ShirtPro', 'ShirtPro Fashion', '280g', 'Size L'),
        (16, 'Sneakers Canvas Low-Top', 'Casual canvas sneakers', 44.99, 22.00, 170, 'SneakerStyle', 'SneakerStyle', '320g', 'Size 10'),
        (17, 'Jacket Windbreaker', 'Lightweight windbreaker jacket', 54.99, 28.00, 110, 'OuterWear', 'OuterWear', '380g', 'Size M'),
        (18, 'Shorts Athletic', 'Quick-dry athletic shorts', 24.99, 10.00, 190, 'SportWear', 'SportWear', '150g', 'Size M'),
        (19, 'Beanie Winter Knit', 'Warm knit beanie hat', 14.99, 6.00, 200, 'HatCraft', 'HatCraft', '75g', 'One Size'),
        (20, 'Umbrella Compact Auto', 'Automatic compact travel umbrella', 19.99, 8.00, 180, 'RainShield', 'RainShield', '320g', '30cm folded')
    ) AS products(generate_series, name, description, price, cost_price, stock_quantity, brand, manufacturer, weight, dimensions);

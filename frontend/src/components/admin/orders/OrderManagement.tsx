            ...
            <Box sx={{ pt: 2 }}>
              ...
              {newStatus === ORDER_STATUS.SHIPPED && (
                <TextField
                  ...
                  sx={{ mt: 2 }}
                  placeholder="Enter tracking number, expected delivery date, and any other relevant information for the customer. This information will be sent to the customer via email."
                  helperText="Include tracking number, carrier name, and expected delivery date. This information will be emailed to the customer."
                />
              )}
            </Box>
          )}
            ...
            <Box sx={{ pt: 2 }}>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 3 }}>
                ...
                <Box sx={{ textAlign: 'right' }}>
                  <Chip label={selectedOrder.statusName} color={getStatusColor(selectedOrder.status)} />
                  <Chip label={selectedOrder.paymentStatusName} sx={{ ml: 1 }} variant="outlined" />
                </Box>
              </Box>
